...
def LoginCompanionForm():
    ...
    lbl_result_empty = Label(LoginCompanionFrame, text="Login For admin", font=('arial', 18), fg="blue")
    lbl_result_empty.grid(row=0, columnspan=2)

    lbl_username = Label(LoginCompanionFrame, text="admin Username:", font=('arial', 18), bd=18)
    lbl_username.grid(row=2)

    lbl_password = Label(LoginCompanionFrame, text="admin Password:", font=('arial', 18), bd=18)
