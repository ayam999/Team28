...
def register():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            db.collection(u'Developertabel').document().set(
                {"email": email, "password": password, "id": id, "firstname": firstname, "lastname": lastname})
...
def registerAdmine():
    ...
    if request.method == 'POST':
        ...
        try:
            Developertabel = auth.create_user_with_email_and_password(email, password)
            data = {"email": email, "password": password, "id": id, "firstname": firstname, "lastname": lastname}
            db.collection(u'Adminetabel').document().set(
                {"email": email, "password": password, "id": id, "firstname": firstname, "lastname": lastname})
